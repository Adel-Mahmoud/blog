...
<body>
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div style="position:fixed;widt:100%;height:100%;">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#view-dashboard" aria-expanded="false"
                        ...
                        <div class="collapse" id="view-dashboard">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#mdi-file" aria-expanded="false"
                            aria-controls="ui-basic">
                        ...
                        <div class="collapse" id="mdi-file">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#mdi-comment" aria-expanded="false"
                            aria-controls="ui-basic">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#mdi-account-group" aria-expanded="false"
                            aria-controls="ui-basic">
                        ...
                        <div class="collapse" id="mdi-account-group">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                    ...
                    <footer class="footer">
                        <div class="d-sm-flex justify-content-center justify-content-sm-between">
                            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright ©
                                bootstrap-adel.com 2020</span>
                            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a
                                    href="#" target="_blank">Bootstrap dashboard
                                    template</a> from Bootstrap-adel.com</span>
                        </div>
                    </footer>
                </div>
                <!-- main-panel ends -->
